#!/bin/bash
#
# Test: Two interconnected devices at 2 kHz, 100ns delay
#
...
LOG_DIR="$SCRIPT_DIR/logs/dual_delay_$TIMESTAMP"
mkdir -p "$LOG_DIR"

echo "=== TIC Dual-Device Test (100ns delay) ==="
echo "Log directory: $LOG_DIR"

# Build and flash both devices
"$SCRIPT_DIR/bin/idf" -f $FREQ_HZ -d $DELAY_NS build flash tic1 tic2 2>&1 | tee "$LOG_DIR/build_flash.log"
